...
<head>
    ...
    <title>RadiusMonitor | Php Admin</title><!--begin::Primary Meta Tags-->
                    ...
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="#" class="nav-link active"> <i class="nav-icon bi mdi--gear"></i>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item"> <a href="./php_admin.php" class="nav-link active"> <i class="nav-icon bi phpmyadmin"></i>
                                        <p>Php Admin</p>
                                    </a> </li>
                                </ul>
                            </li>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-12 d-flex flex-column">
            <div class="panel panel-hovered mb-20 panel-primary flex-fill">
                <div class="panel-heading">PhpMyAdmin</div>
                <div class="panel-body">
                    <div class="md-whiteframe-z1 mb-20 text-center" style="padding: 15px;">
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed table-striped">
                                <iframe id="phpmyadmin" width="100%" height="600px" style="border:none;"></iframe>
                            </table>
                        </div>
                    </div>
                </div>
...
document.getElementById("phpmyadmin").src = window.location.protocol + "//" + window.location.host + "/RadiusMonitor/phpmyadmin";
</script>
</body>
</html>